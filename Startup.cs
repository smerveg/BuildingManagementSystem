...
using BuildingManagementSystem.ConsumeApi.Clients.Concrete;
...
using RoomManagementSystem.ConsumeApi.Clients.Concrete;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace BuildingManagementSystem.ConsumeApi
{
    public class Startup
    {
        ...
        {
            services.AddHttpClient<IBuildingClient, BuildingClient>();
            services.AddHttpClient<IRoomClient, RoomClient>();
